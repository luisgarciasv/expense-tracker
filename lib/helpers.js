            ...
            .then((data) => {
                ...
                try {
                    return writeFilePromise(generatePath(), JSON.stringify(data))
                        .then((_data) => {
                            if (this instanceof AddExpense) {
                                return `Expense ${newExpense.description} added successfully.`;
                            }
                            if (this instanceof UpdateExpense) {
                                return `Expense ${newExpense.description} updated successfully.`;
                            }
                            if (this instanceof DeleteExpense) {
                                return `Expense ${newExpense.description} deleted successfully.`;
                            }
                        });
                } catch (err) {
